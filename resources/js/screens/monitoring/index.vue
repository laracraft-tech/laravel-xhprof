<script type="text/ecmascript-6">
    ...
    export default {
         ...
         */
        mounted(){
            document.title = "Monitoring - Spyglass";


            axios.get(Spyglass.basePath + '/spyglass-api/monitored-tags').then(response => {
        ...
        methods: {
            removeTag(tag){
                this.alertConfirm('Are you sure you want to remove this tag?', ()=> {
                    ...
                    axios.post(Spyglass.basePath + '/spyglass-api/monitored-tags/delete', {tag: tag});
                });
            },
            ...
            monitorNewTag(){
                if (this.newTag.length) {
                    axios.post(Spyglass.basePath + '/spyglass-api/monitored-tags', {tag: this.newTag});

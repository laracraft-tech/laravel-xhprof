<script type="text/ecmascript-6">
    ...
    export default {
        ...
        methods: {
            loadEntries(){
                axios.post(Spyglass.basePath + '/spyglass-api/dumps').then(response => {
                    this.ready = true;
            ...
            checkForNewEntries(){
                this.newEntriesTimeout = setTimeout(() => {
                    axios.post(Spyglass.basePath + '/spyglass-api/dumps?take=1').then(response => {
                        this.recordingStatus = response.data.status;
...
<template>
    <div class="card">
        ...
        <p v-if="recordingStatus !== 'enabled'" class="mt-0 mb-0 disabled-watcher">
            ...
            <span class="ml-1" v-if="recordingStatus == 'disabled'">Spyglass is currently disabled.</span>
            <span class="ml-1" v-if="recordingStatus == 'paused'">Spyglass recording is paused.</span>
